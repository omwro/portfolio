<template>
    <div class="flex flex-row gap-4 bg-primary-block-light dark:bg-primary-block-dark p-4 pr-8 rounded-[60px_15px] border-4 border-primary items-center">
...
import { getGroupedExperience } from "../../composables/useSkills";
</script>
